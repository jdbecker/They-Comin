...
func _set_gun_stats(value: GunStats) -> void:
	...
	_set_stylized_gun_stat(damage, gun_stats.damage, Global.data.gun_in_hand.damage)
	_set_stylized_gun_stat(rate_of_fire, gun_stats.rate_of_fire, Global.data.gun_in_hand.rate_of_fire)

func _set_stylized_gun_stat(element: Label, stat: float, in_hand: float) -> void:
